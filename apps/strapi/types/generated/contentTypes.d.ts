...
export interface ApiCategoryCategory extends Schema.CollectionType {
	...
	attributes: {
		...
		>
		seo: Attribute.Component<'prices.seo', true> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
		...
		rozetka_name: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_id: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
...
export interface ApiCuoponCuopon extends Schema.CollectionType {
	collectionName: 'cuopons'
	info: {
		singularName: 'cuopon'
		pluralName: 'cuopons'
		displayName: 'cuopons'
	...
	attributes: {
		...
		updatedAt: Attribute.DateTime
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<'api::cuopon.cuopon', 'oneToOne', 'admin::user'> &
			Attribute.Private
		updatedBy: Attribute.Relation<'api::cuopon.cuopon', 'oneToOne', 'admin::user'> &
			Attribute.Private
	}
}
...
export interface ApiOrderOrder extends Schema.CollectionType {
	...
	attributes: {
		...
		status: Attribute.Enumeration<['pending', 'done', 'canceled']> & Attribute.DefaultTo<'pending'>
		sum: Attribute.Decimal & Attribute.DefaultTo<0>
		uuid: Attribute.UID
		info: Attribute.Text
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
...
export interface ApiProductProduct extends Schema.CollectionType {
	...
	attributes: {
		...
		composition: Attribute.RichText &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
		...
		storage: Attribute.RichText &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		energy: Attribute.JSON &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
		...
		name_rozetka: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		description_rozetka: Attribute.RichText &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_filter_vid: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_filter_tip: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_filter_upakovka: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_filter_krayina_virobnyk: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_filter_obosblivosti: Attribute.JSON &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: false
				}
			}>
		rozetka_termin_zberiganya: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_filter_vaga: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_filter_umovi_zberiganya: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_filter_harchova: Attribute.String &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		rozetka_available: Attribute.Boolean &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
		...
		rozetka_images: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
...
export interface ApiSubcategorySubcategory extends Schema.CollectionType {
	...
	attributes: {
		...
		sort: Attribute.Enumeration<['low', 'high']>
		rozetka_name: Attribute.String
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		publishedAt: Attribute.DateTime
...
export interface ApiUserAdressFormUserAdressForm extends Schema.SingleType {
	collectionName: 'user_adress_forms'
	info: {
		singularName: 'user-adress-form'
		pluralName: 'user-adress-forms'
		displayName: 'User adress form'
		description: ''
	}
	options: {
		draftAndPublish: true
	...
	attributes: {
		...
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<
			'api::user-adress-form.user-adress-form',
			'oneToOne',
			'admin::user'
		> &
			Attribute.Private
...
export interface ApiUserRegisterFromUserRegisterFrom extends Schema.SingleType {
	collectionName: 'user_register_froms'
	info: {
		singularName: 'user-register-from'
		pluralName: 'user-register-froms'
	...
	attributes: {
		...
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<
			'api::user-register-from.user-register-from',
			'oneToOne',
			'admin::user'
		> &
			Attribute.Private
...
export interface ApiUserSettingsFormUserSettingsForm extends Schema.SingleType {
	collectionName: 'user_settings_forms'
	info: {
		singularName: 'user-settings-form'
		pluralName: 'user-settings-forms'
		displayName: 'User settings form'
		description: ''
	}
	options: {
		draftAndPublish: true
	...
	attributes: {
		...
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<
			'api::user-settings-form.user-settings-form',
			'oneToOne',
			'admin::user'
		> &
			Attribute.Private
...
declare module '@strapi/types' {
	export module Shared {
		export interface ContentTypes {
			...
			'api::cuopon.cuopon': ApiCuoponCuopon
			'api::order.order': ApiOrderOrder
			'api::product.product': ApiProductProduct
			'api::subcategory.subcategory': ApiSubcategorySubcategory
			'api::user-adress-form.user-adress-form': ApiUserAdressFormUserAdressForm
			'api::user-register-from.user-register-from': ApiUserRegisterFromUserRegisterFrom
			'api::user-settings-form.user-settings-form': ApiUserSettingsFormUserSettingsForm
		}
	}
}
